...
\begin{enumerate}
    ...
    \lstinputlisting[firstline=124, lastline=127]{src/chapter3/PraktekAlit_1174057.py}
    ...
    \lstinputlisting[firstline=129, lastline=132]{src/chapter3/PraktekAlit_1174057.py}

    Statemen return digunakan untuk keluar dari fungsi. Kita juga dapat menspesifikasikan nilai kembalian.
    \lstinputlisting[firstline=134, lastline=141]{src/chapter3/PraktekAlit_1174057.py}
    ...
    Cara pemanggilannya
    \lstinputlisting[firstline=143, lastline=144]{src/chapter3/PraktekAlit_1174057.py}
    ...
    \lstinputlisting[firstline=146, lastline=168]{src/chapter3/PraktekAlit_1174057.py}
    ...
    \end{itemize}
    \lstinputlisting[firstline=170, lastline=175]{src/chapter3/PraktekAlit_1174057.py}
...
\begin{enumerate}
    ...
    untuk NPM mod3=2.
    \lstinputlisting[firstline=184, lastline=234]{src/chapter3/PraktekAlit_1174057.py}
    ...
    NPM.
    \lstinputlisting[firstline=237, lastline=243]{src/chapter3/PraktekAlit_1174057.py}
    ...
    \lstinputlisting[firstline=245, lastline=255]{src/chapter3/PraktekAlit_1174057.py}
    ...
    \lstinputlisting[firstline=257, lastline=263]{src/chapter3/PraktekAlit_1174057.py}

    \item buat fungsi program dengan input variabel NPM dan melakukan print nomor npm satu persatu kebawah.
    \lstinputlisting[firstline=265, lastline=269]{src/chapter3/PraktekAlit_1174057.py}
    ...
    atau kondisi.
    \lstinputlisting[firstline=272, lastline=279]{src/chapter3/PraktekAlit_1174057.py}
    ...
    atau kondisi.
    \lstinputlisting[firstline=281, lastline=288]{src/chapter3/PraktekAlit_1174057.py}
    ...
    \lstinputlisting[firstline=290, lastline=296]{src/chapter3/PraktekAlit_1174057.py}

    \item Buatlah fungsi dengan inputan variabel NPM, Lakukan print NPM anda tapi
    hanya dijit ganjil saja. wajib menggunakan perulangan dan atau kondisi.
    \lstinputlisting[firstline=298, lastline=304]{src/chapter3/PraktekAlit_1174057.py}

    \item Buatlah fungsi dengan inputan variabel NPM, Lakukan print NPM anda tapi
    hanya dijit yang termasuk bilangan prima saja. wajib menggunakan perulangan
    dan atau kondisi.
    \lstinputlisting[firstline=306, lastline=320]{src/chapter3/PraktekAlit_1174057.py}
    ...
    \lstinputlisting[firstline=7, lastline=7]{src/chapter3/mainAlit_1174057.py}
    ...
    pada file main.py.
    \lstinputlisting[firstline=8, lastline=9]{src/chapter3/mainAlit_1174057.py}
...
\begin{enumerate}
	...
	\end{itemize}
		...
		\lstinputlisting{src/chapter3/ErrorKu_1174057.py}
