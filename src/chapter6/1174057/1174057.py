...
plt.hist(orang, umur, histtype='bar', rwidth=0.8, color='r')
plt.xlabel('Umur')
...
plt.scatter(x,y, label='keuntungan tinggi simpanan rendah',color='g')
plt.scatter(x1,y1,label='keuntungan rendah simpanan tinggi',color='b')
...
plt.plot([],[],color='b', label='Futsal', linewidth=5)
plt.plot([],[],color='y', label='Kuliah', linewidth=5)
plt.plot([],[],color='k', label='Youtube-an', linewidth=5)
...
potong = [7,2,2,12]
kegiatan = ['Tidur','Futsal','Kuliah','Youtube-an']
kolom = ['c','m','y','g']
...
plt.plot(x,y)
plt.title('Peminat bahasa pemogramman Python')
plt.ylabel('Tahun')
plt.xlabel('Jumlah Pengguna sistem operasi Python')
plt.show()
...
plt.plot(x,y,'b',label='Team Bapao', linewidth=1)
plt.plot(x2,y2,'r',label='Ateam',linewidth=1)
plt.title('Dunia Youtube')
...
bar = __import__('1174057_bar')
scat = __import__('1174057_scatter')
pie = __import__('1174057_pie')
plot = __import__('1174057_plot')
